...
<div class="main-nav">
				<div class="container">
					<nav class="navbar navbar-expand-lg navbar-light">
						<a class="navbar-brand" href="index-five.html">
						...
						<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
							...
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item">
									<a href="find-job.php" >JOBS</a>

									<ul class="dropdown-menu">
										<li class="nav-item">
											<a href="find-job.php" class="nav-link">Find A Job</a>
										</li>
										<li class="nav-item">
											<a href="post-job.php" class="nav-link">Post A Job</a>
										</li>
										
										<li class="nav-item">
											<a href="job-grid.php" class="nav-link">Job Grid</a>
										</li>
