      ...
      <div class="page-content">
        ...
        <?php
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sq = "UPDATE category SET name='$category_name',date='$date' WHERE id='$id'";
        ...
        <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="mb-0 text-uppercase">Edit Category information</h6>
                  <hr>
                  <form class="row g-3" method="post" >
                    <div class="col-12">
                      <label class="form-label">Category name</label>
                      <input type="text" name="category_name" value="<?php echo $row['name'] ?>" class="form-control" placeholder="Enter company name" required>
                    </div>
