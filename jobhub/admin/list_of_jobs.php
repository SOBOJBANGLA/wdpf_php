                          ...
                          <tr style="text-align:center">
                            ...
                            <td>
                              <div class="button-items">
                                <a href='edit_job_list.php?id=<?php echo $data['id']  ?>'> <input class="btn btn-info" type="submit" value="Edit"></a>
                                <a onclick="return confirm('Are you sure to delete?')" href='delete_job_list.php?id=<?php echo $data['id']  ?>'><input class="btn btn-danger" type="reset" value="Delete"></a>
                              </div>
                            </td>
