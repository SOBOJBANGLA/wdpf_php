          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0 align-items-center">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="padding: 10px;">Jobs Title</li>
              </ol>
            </nav>
          </div>
...
<div class="container-fluid">
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tile List</h4>
                                            ...
                                            <td><?php echo $data['date'] ?></td>
                                                <td>
                                                    <div class="button-items">
                                                        <a href='edit_title.php?id=<?php echo $data['id'] ?>'>  <input class="btn btn-info" type="submit" value="Edit"></a>
                                                <a onclick="return confirm('Are you sure to delete?')" href='delete_title.php?id=<?php echo $data['id'] ?>'><input class="btn btn-danger" type="reset" value="Delete"></a>
                                                </div>
                                            </td>
