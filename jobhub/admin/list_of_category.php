            ...
            <div class="ps-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                  ...
                  <li class="breadcrumb-item active" aria-current="page" style="padding: 10px;">Jobs Category</li>
                </ol>
              </nav>
            </div>
                          ...
                          <td><?php echo $data['id'] ?></td>
                            ...
                            <td>
                              <div class="button-items">
                                <a href='edit_category.php?id=<?php echo $data['id'] ?>'> <input class="btn btn-info" type="submit" value="Edit"></a>
                                <a onclick="return confirm('Are you sure to delete?')" href='delete_category.php?id=<?php echo $data['id'] ?>'><input class="btn btn-danger" type="reset" value="Delete"></a>
                              </div>
                            </td>
