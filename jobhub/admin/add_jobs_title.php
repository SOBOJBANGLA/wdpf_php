      ...
      <div class="page-content">
        ...
        <?php
								if(isset($_POST['submit'])){
									...
									extract($_POST);
									$sql =  "INSERT INTO title (name,date) 
											 VALUES ('$name','$date')";
        ...
        <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="mb-0 text-uppercase">Jobs Title information</h6>
                  <hr>
                  <form class="row g-3" method="post" >
                    <div class="col-12">
                      <label class="form-label">Title Name</label>
                      <input type="text" name="name" class="form-control" placeholder="Enter Title name" required>
                    </div>
