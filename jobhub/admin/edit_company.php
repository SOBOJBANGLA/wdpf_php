      ...
      <div class="page-content">
        ...
        <?php
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sq = "UPDATE company SET name='$company_name',address='$address',date='$date' WHERE id='$id'";
                            ...
                            $sql = $conn->query("SELECT * FROM company WHERE id='$id'");
                                $row = $sql->fetch_assoc();
        ...
        <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="mb-0 text-uppercase">Edit Company information</h6>
                  <hr>
                  <form class="row g-3" method="post" >
                    <div class="col-12">
                      <label class="form-label">Company name</label>
                      <input type="text" name="company_name" value="<?php echo $row['name'] ?>" class="form-control" placeholder="Enter company name" required>
                    </div>
                    <div class="col-12">
                    <label>Address</label>
